...
if (isset($_POST['submit'])) {
    if (!empty($_POST['nom']) && !empty($_POST['email']) && !empty($_POST['commentaire'])){
        ...
        $insertUser = $db->prepare('INSERT INTO contact(nom, email, commentaire) VALUES(:nom, :email, :commentaire)');
        $insertUser->bindParam(':nom', $nom);
        $insertUser->bindParam(':email', $email);
        $insertUser->bindParam(':commentaire', $commentaire);
        $insertUser->execute();
                ...
                <div class="col-md-6 col-xl-4">
                    <div>
                        <form class="p-3 p-xl-4" method="post">
                            <div class="mb-3"><input class="form-control" type="text" id="text"  name="nom" placeholder="Nom"></div>
